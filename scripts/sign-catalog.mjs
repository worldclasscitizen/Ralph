...
if (!resolve(privateKeyPath).startsWith("/")) throw new Error("private key는 절대 경로로 지정해야 합니다.");
const catalogPath = resolve(process.argv[2] ?? "assets/catalog.json");
const signaturePath = resolve(process.argv[3] ?? "assets/catalog.sig");
