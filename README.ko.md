...
Ralph 0.3.0은 출시 검증 중입니다. 그래프 런타임과 운영체제별 CI를 구현했지만 실제 비교 검증을 끝내지 못해 정식 게시를 보류하고 있습니다. [검증 기록](./docs/project/release-campaign-2026-09-05.md)에 실패 원인, 보완한 검증 fixture와 보존한 호출 예산을 기록했습니다. 그래프 구조만으로 품질·속도·비용 우위를 주장하지 않습니다.
